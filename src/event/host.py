...
class Host:
  ...
  def __init__(self, host_data = None):
    ...
    if host_data is not None:
      ...
      self.host_data = {"id": host_data["id"], "common_name": host_data["common_name"], "level": host_data["level"], "hierarchy": host_data["hierarchy"]}
  ...
  def add_host_info(self, id, common_name, hierarchy_data_as_list):
    ...
    if self.is_host_info_empty():
      ...
      # # update hier level
      #
      self.host_data = {"id": id, "common_name": common_name, "level": nb_items, "hierarchy": hierarchy_data_as_list}
