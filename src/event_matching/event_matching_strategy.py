...
from event.event_duplicate_identification_strategy import EventDuplicateHierIdentificationStrategy
from event.event import Event

import numpy as np
from event.event_similarity_strategy import EventSimilarityStrategyManual
